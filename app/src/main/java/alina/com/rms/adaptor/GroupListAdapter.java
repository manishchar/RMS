...
import alina.com.rms.activities.headquaterActivities.HeaduaterGroupList;
...
public class GroupListAdapter extends RecyclerView.Adapter<GroupListAdapter.ViewHolder> {
    ...
    private HeaduaterGroupList mContext;
    private List<Grouplist> headquaterlist;
    public GroupListAdapter(Context context, ServiceClickCallBack callBackListner, List<Grouplist> headquaterlist) {
        this.mContext = (HeaduaterGroupList) context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.group_list_adapter, parent, false);
