...
public class LoginDB {
    ...
    public static final String loginCredendialsAsJSON="loginCredendialsAsJSON";
    public static final String user_data="USER_DATA";
    public static final String loginFlag="LOGIN_FLAG";

    public static boolean LOGIN_FLAG;

    public static void setLoginResponseAsJSON(Context context, String value) {
        SharedPreferences pref = PreferenceManager
                .getDefaultSharedPreferences(context);
        SharedPreferences.Editor edit = pref.edit();
        edit.putString(loginCredendialsAsJSON, value);
        edit.putBoolean(loginFlag,true);
        edit.commit();
    }

    public static void setLoginResponseAsJSONForUSER(Context context, String value) {
        SharedPreferences pref = PreferenceManager
                .getDefaultSharedPreferences(context);
        SharedPreferences.Editor edit = pref.edit();
    ...
    public static String getLoginResponseAsJSON(Context context) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        String string = pref.getString(loginCredendialsAsJSON, "");
        return string;
    }

    public static String getUSerResponseAsJSON(Context context) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        String string = pref.getString(user_data, "");
        return string;
    }
