...
public class MakingNavigationDrawerForSuperAdmin {
    ...
    public MakingNavigationDrawerForSuperAdmin(Context context , RecyclerView recyclerView)
    {
    ...
    private void prepareMovieData() {
        String [] array=new String[]{"DashBoard","Headquater","User List",/*"Report",*/"Public Module",/*"Add/Edit Foundation","Add/Edit MastEriction","Add/Edit Wiring",*/"Logout"};
