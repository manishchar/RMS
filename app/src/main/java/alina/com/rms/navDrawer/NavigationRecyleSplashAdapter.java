...
public class NavigationRecyleSplashAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NavigationRecyleSplashAdapter(List<AdapterGetterSetter> adapterGetterSettersList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new NavigationRecyleSplashAdapter.NavItemViewHolder(itemView);
/*        itemView=  LayoutInflater.from(parent.getContext())
                .inflate(R.layout.nav_item_list_view, parent, false);
