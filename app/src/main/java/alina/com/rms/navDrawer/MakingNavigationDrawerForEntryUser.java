...
public class MakingNavigationDrawerForEntryUser {
    ...
    public MakingNavigationDrawerForEntryUser(Context context , RecyclerView recyclerView)
    {
    ...
    private void prepareMovieData() {
        String [] array=new String[]{"Weekly Report","Report","Logout"};
        TypedArray tArray = context.getResources().obtainTypedArray(
                R.array.random_imgs_user);
