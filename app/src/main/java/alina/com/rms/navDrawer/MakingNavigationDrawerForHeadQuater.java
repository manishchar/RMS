...
public class MakingNavigationDrawerForHeadQuater {
    ...
    public MakingNavigationDrawerForHeadQuater(Context context , RecyclerView recyclerView)
    {
    ...
    private void prepareMovieData() {
        String [] array=new String[]{"DashBoard","OHE","PSI","TR Line","Other","Report","User Manual","Logout"};
