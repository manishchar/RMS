...
public class MakingNavigationDrawerForHeaduater {
    ...
    public MakingNavigationDrawerForHeaduater(Context context , RecyclerView recyclerView)
    {
    ...
    private void prepareMovieData() {
        String [] array=new String[]{"DashBoard","Group List","User List","Section List","Master List","Target","Report",
                /*"Weekly Report",*/"Logout"};
        TypedArray tArray = context.getResources().obtainTypedArray(
                R.array.random_imgs_headquater);
