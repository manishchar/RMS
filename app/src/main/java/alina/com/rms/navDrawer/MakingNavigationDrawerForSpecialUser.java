...
public class MakingNavigationDrawerForSpecialUser {
    ...
    public MakingNavigationDrawerForSpecialUser(Context context , RecyclerView recyclerView)
    {
    ...
    private void prepareMovieData() {
        String [] array=new String[]{"OHE","TSS","SP","SSP","REPORT","Logout"};
        TypedArray tArray = context.getResources().obtainTypedArray(
                R.array.random_imgs_speical_user);
