...
public class MakingNavigationDrawerForPublicModule {
    ...
    public MakingNavigationDrawerForPublicModule(Context context , RecyclerView recyclerView)
    {
    ...
    private void prepareMovieData() {
        String [] array=new String[]{/*"Public Module",*/"OHE","TSS","SP","SSP","REPORT","Logout"};
        TypedArray tArray = context.getResources().obtainTypedArray(
                R.array.random_imgs_public_module);
