...
import alina.com.rms.activities.headquater_special_user_adapter.HeadQuaterSpecialUserViewTSSActivityListAdapter;
...
public class HeadQuaterSpecialUserViewProgressTSSList extends HeadQuaterSpecialUserBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private HeadQuaterSpecialUserViewTSSActivityListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(HeadQuaterSpecialUserViewProgressTSSList.this);
    ...
    private void hitToServer()
    {
        ...
        AsyncController asyncController=new AsyncController(HeadQuaterSpecialUserViewProgressTSSList.this,this,
    ...
    private void initUI() {
        ...
        servicesListAdapter = new HeadQuaterSpecialUserViewTSSActivityListAdapter(HeadQuaterSpecialUserViewProgressTSSList.this, this,wiringProgressLists);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(HeadQuaterSpecialUserViewProgressTSSList.this, HeadQuaterSpecialUserProgressTSSActivity.class);
    ...
    {
        Intent intent = new Intent(HeadQuaterSpecialUserViewProgressTSSList.this,HeadQuaterSpecialUserProgressEditTSSActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        AlertDialog.Builder builder;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(HeadQuaterSpecialUserViewProgressTSSList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(HeadQuaterSpecialUserViewProgressTSSList.this);
        }
        builder.setTitle("Delete Public Module")
                .setMessage("Are you sure you want to delete this entry?")
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // continue with delete
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(HeadQuaterSpecialUserViewProgressTSSList.this, HeadQuaterSpecialUserViewProgressTSSList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
                ...
                if(response1!=null)
                {
                    if(response1.getActivityProgressList()!=null)
                    {
                       ...
                       // Log.e("value","".size());
                        ...
                        Toast.makeText(HeadQuaterSpecialUserViewProgressTSSList.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(HeadQuaterSpecialUserViewProgressTSSList.this,"no data found",Toast.LENGTH_LONG).show();
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        if(response1.getResponseCode()==1)
                        {
                            ...
                            Toast.makeText(HeadQuaterSpecialUserViewProgressTSSList.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            hitToServer();
                        }

                    }
                    else {
                        Toast.makeText(HeadQuaterSpecialUserViewProgressTSSList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(HeadQuaterSpecialUserViewProgressTSSList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
            ...
            else if(callType==CallType.DELETE_MODULE)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        ...
                        Toast.makeText(HeadQuaterSpecialUserViewProgressTSSList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(HeadQuaterSpecialUserViewProgressTSSList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
