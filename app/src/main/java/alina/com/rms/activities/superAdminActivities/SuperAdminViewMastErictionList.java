...
import alina.com.rms.adaptor.SuperAdminMasterViewListAdapter;
...
public class SuperAdminViewMastErictionList extends SuperAdminBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private SuperAdminMasterViewListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(SuperAdminViewMastErictionList.this);
    ...
    private void hitToServer()
    {
        ...
        AsyncController asyncController=new AsyncController(SuperAdminViewMastErictionList.this,this,
    ...
    private void initUI() {
        ...
        servicesListAdapter = new SuperAdminMasterViewListAdapter(SuperAdminViewMastErictionList.this, this,mastProgressLists);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(SuperAdminViewMastErictionList.this, SuperAdminMastErictionActivity.class);
    ...
    {
        Intent intent = new Intent(SuperAdminViewMastErictionList.this,SuperAdminMastErictionEditActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        AlertDialog.Builder builder;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(SuperAdminViewMastErictionList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(SuperAdminViewMastErictionList.this);
        }
        builder.setTitle("Delete Public Module")
                .setMessage("Are you sure you want to delete this entry?")
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // continue with delete
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(SuperAdminViewMastErictionList.this,SuperAdminViewMastErictionList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
                ...
                if(response1!=null)
                {
                    if(response1.getMastProgressList()!=null)
                    {
                       ...
                       // Log.e("value","".size());
                        ...
                        Toast.makeText(SuperAdminViewMastErictionList.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminViewMastErictionList.this,"no data found",Toast.LENGTH_LONG).show();
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        if(response1.getResponseCode()==1)
                        {
                            ...
                            Toast.makeText(SuperAdminViewMastErictionList.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            hitToServer();
                        }

                    }
                    else {
                        Toast.makeText(SuperAdminViewMastErictionList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminViewMastErictionList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
            ...
            else if(callType==CallType.DELETE_MODULE)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        ...
                        Toast.makeText(SuperAdminViewMastErictionList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminViewMastErictionList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
