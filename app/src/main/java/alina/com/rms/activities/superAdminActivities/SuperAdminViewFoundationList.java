...
import alina.com.rms.adaptor.SuperAdminFoundationViewListAdapter;
...
public class SuperAdminViewFoundationList extends SuperAdminBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private SuperAdminFoundationViewListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(SuperAdminViewFoundationList.this);
    ...
    private void hitToServer()
    {
        ...
        AsyncController asyncController=new AsyncController(SuperAdminViewFoundationList.this,this,
    ...
    private void initUI() {
        ...
        servicesListAdapter = new SuperAdminFoundationViewListAdapter(SuperAdminViewFoundationList.this, this,foundationProgressLists);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(SuperAdminViewFoundationList.this, SuperAdminFoundationActivity.class);
    ...
    {
        Intent intent = new Intent(SuperAdminViewFoundationList.this,SuperAdminFoundationEditActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        AlertDialog.Builder builder;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(SuperAdminViewFoundationList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(SuperAdminViewFoundationList.this);
        }
        builder.setTitle("Delete Public Module")
                .setMessage("Are you sure you want to delete this entry?")
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // continue with delete
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(SuperAdminViewFoundationList.this,SuperAdminViewFoundationList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
            ...
            if(callType==CallType.VIEW_FOUNDATION_MODEL)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getFoundationProgressList()!=null)
                    {
                        ...
                        Toast.makeText(SuperAdminViewFoundationList.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminViewFoundationList.this,"no data found",Toast.LENGTH_LONG).show();
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        if(response1.getResponseCode()==1)
                        {
                            ...
                            Toast.makeText(SuperAdminViewFoundationList.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            hitToServer();
                        }

                    }
                    else {
                        Toast.makeText(SuperAdminViewFoundationList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminViewFoundationList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
            ...
            else if(callType==CallType.DELETE_MODULE)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        ...
                        Toast.makeText(SuperAdminViewFoundationList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminViewFoundationList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
