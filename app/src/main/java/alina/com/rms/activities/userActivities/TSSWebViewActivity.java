...
public class TSSWebViewActivity extends AppCompatActivity implements AsyncCompleteListner,AdapterView.OnItemSelectedListener {
    ...
    public void getOHETarget()
    {
        ...
        AsyncController asyncController=new AsyncController(TSSWebViewActivity.this,this, CallType.GET_TSS_TARGET,"",true);
                ...
                if (callType == CallType.GET_TSS_TARGET) {try {
                        ...
                        if (jsonObject.has("response_code")) {
                            if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                                Util.showLongToast(TSSWebViewActivity.this, "No data available");
