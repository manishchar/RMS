...
public class ProcessHeadquaterEntryUserActivity extends UserEntryBaseActivity implements AsyncCompleteListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_response= LoginDB.getLoginResponseAsJSON(ProcessHeadquaterEntryUserActivity.this);
    ...
    private void initUI() {
        ...
        date_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                openDatePickerDialog(selected_date_text,ProcessHeadquaterEntryUserActivity.this);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Util.showShortToast(ProcessHeadquaterEntryUserActivity.this,"Select date");
                    return;
                }

                /*else if(Integer.parseInt(achiveEditText.getText().toString())>Integer.parseInt(targetEditText.getText().toString()))
                {
                    Util.showShortToast(ProcessHeadquaterEntryUserActivity.this,"Achive value should be equal or less then Targeted value");
                    return;
                }*/
                submitValue();
                // submitValue();
    ...
    public void getOHETarget()
    {
        ...
        AsyncController asyncController=new AsyncController(ProcessHeadquaterEntryUserActivity.this,this, CallType.GET_OHE,"",true);
    ...
    {
        setProgressDialoug(true);
        AsyncController asyncController=new AsyncController(ProcessHeadquaterEntryUserActivity.this,this, CallType.GET_TARGET_VALUE,"",true);
        asyncController.setProgressDialoug(true);
    ...
    public void submitValue()
    {
        ...
        setProgressDialoug(true);
        AsyncController asyncController=new AsyncController(ProcessHeadquaterEntryUserActivity.this,this, CallType.SUBMITTED_VALUE,loginResultPojo1,true);
        asyncController.setProgressDialoug(true);
        ...
        if (response != null) {
            if (callType == CallType.GET_OHE) {
                try {
                    ...
                    if (jsonObject.has("response_code")) {
                        if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                            Util.showLongToast(ProcessHeadquaterEntryUserActivity.this, "No data available");
                ...
                try {
                    ...
                    if (jsonObject.has("response_code")) {
                        if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                            Util.showLongToast(ProcessHeadquaterEntryUserActivity.this, "No Target available");
                ...
                try {
                    ...
                    if (jsonObject.has("response_code")) {
                        if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                            ...
                            selected_date_text.setText("");
                            Util.showDialog(ProcessHeadquaterEntryUserActivity.this,"Your data not saved successfully");
                        }
                        else {
                            selected_date_text.setText("");
                            linear_add.setVisibility(View.GONE);
                            ...
                            Util.showDialog(ProcessHeadquaterEntryUserActivity.this,"Your data saved successfully");
                            //finish();
                            // selected_date_text.setText("");
                ...
                Util.showShortToast(ProcessHeadquaterEntryUserActivity.this, "Error in connection");
            }
        }
    }
