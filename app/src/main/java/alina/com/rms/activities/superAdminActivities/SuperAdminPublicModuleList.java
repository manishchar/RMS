...
import alina.com.rms.adaptor.SuperAdminPublicModuleListAdapter;
...
public class SuperAdminPublicModuleList extends SuperAdminBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private SuperAdminPublicModuleListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(SuperAdminPublicModuleList.this);
    ...
    private void hitToServer()
    {
        ...
        AsyncController asyncController=new AsyncController(SuperAdminPublicModuleList.this,this,
    ...
    private void initUI() {
        ...
        servicesListAdapter = new SuperAdminPublicModuleListAdapter(SuperAdminPublicModuleList.this, this,rkmLists);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(SuperAdminPublicModuleList.this, PublicMouleSuperAdminActivity.class);
    ...
    {
        Intent intent = new Intent(SuperAdminPublicModuleList.this,SuperAdminPublicMouleEditActivity.class);
            ...
            if(callType==CallType.GET_PUBLIC_MODULE_LIST)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getRkmList()!=null)
                    {
                        ...
                        Toast.makeText(SuperAdminPublicModuleList.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminPublicModuleList.this,"no data found",Toast.LENGTH_LONG).show();
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        if(response1.getResponseCode()==1)
                        {
                            ...
                            Toast.makeText(SuperAdminPublicModuleList.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            hitToServer();
                        }

                    }
                    else {
                        Toast.makeText(SuperAdminPublicModuleList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminPublicModuleList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
            ...
            else if(callType==CallType.DELETE_MODULE)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        ...
                        Toast.makeText(SuperAdminPublicModuleList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminPublicModuleList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
