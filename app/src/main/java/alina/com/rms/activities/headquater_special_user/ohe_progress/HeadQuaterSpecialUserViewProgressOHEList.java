package alina.com.rms.activities.headquater_special_user.ohe_progress;
...
import alina.com.rms.activities.headquater_special_user_adapter.HeadQuaterSpecialUserViewActivityListAdapter;
...
public class HeadQuaterSpecialUserViewProgressOHEList extends HeadQuaterSpecialUserBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private HeadQuaterSpecialUserViewActivityListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(HeadQuaterSpecialUserViewProgressOHEList.this);
    ...
    private void hitToServer()
    {
        ...
        AsyncController asyncController=new AsyncController(HeadQuaterSpecialUserViewProgressOHEList.this,this,
                CallType.VIEW_MASTERICTION_MODEL,"",true);
        asyncController.setProgressDialoug(true);
        asyncController.getActivityProgressList(loginResultPojo1.getHeadquater(),""+loginResultPojo1.getRole(),
                loginResultPojo1.getUserId(),loginResultPojo1.getName(),""+loginResultPojo1.getUser_type());

    }

    private void initUI() {
        headingText.setText("OHE Progress List");
        ...
        servicesListAdapter = new HeadQuaterSpecialUserViewActivityListAdapter(HeadQuaterSpecialUserViewProgressOHEList.this, this,wiringProgressLists);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(HeadQuaterSpecialUserViewProgressOHEList.this, HeadQuaterSpecialUserProgressOHEActivity.class);
    ...
    {
        Intent intent = new Intent(HeadQuaterSpecialUserViewProgressOHEList.this,HeadQuaterSpecialUserProgressEditActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        AlertDialog.Builder builder;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(HeadQuaterSpecialUserViewProgressOHEList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(HeadQuaterSpecialUserViewProgressOHEList.this);
        }
        builder.setTitle("Delete Public Module")
                .setMessage("Are you sure you want to delete this entry?")
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // continue with delete
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(HeadQuaterSpecialUserViewProgressOHEList.this, HeadQuaterSpecialUserViewProgressOHEList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
                        asyncController.getDeleteProgressActivity(id);
                    }
                })
                .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                ...
                if(response1!=null)
                {
                    if(response1.getActivityProgressList()!=null)
                    {
                       ...
                       // Log.e("value","".size());
                        ...
                        Toast.makeText(HeadQuaterSpecialUserViewProgressOHEList.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(HeadQuaterSpecialUserViewProgressOHEList.this,"no data found",Toast.LENGTH_LONG).show();
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        if(response1.getResponseCode()==1)
                        {
                            ...
                            Toast.makeText(HeadQuaterSpecialUserViewProgressOHEList.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            hitToServer();
                        }

                    }
                    else {
                        Toast.makeText(HeadQuaterSpecialUserViewProgressOHEList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(HeadQuaterSpecialUserViewProgressOHEList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
            ...
            else if(callType==CallType.DELETE_MODULE)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        ...
                        Toast.makeText(HeadQuaterSpecialUserViewProgressOHEList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(HeadQuaterSpecialUserViewProgressOHEList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
