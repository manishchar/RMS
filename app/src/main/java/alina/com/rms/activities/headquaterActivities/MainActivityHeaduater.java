...
public class MainActivityHeaduater extends HeaduaterBaseActivity implements AdapterView.OnItemSelectedListener, AsyncCompleteListner {
            ...
            public void onClick(View v) {
                ...
                if (checkWebView) {
                    ...
                    if (screen_pos == 1) {
                        ...
                        intent = new Intent(MainActivityHeaduater.this, EntryUserWebViewActivity.class);
                    }
                    intent.putExtra("screen_name", "OHE Report");
                } else {
                    intent = new Intent(MainActivityHeaduater.this, ProcessHeadquaterActivity.class);
                }
...
/*        servicesListAdapter = new HeadquaterServicesListAdapter(MainActivityHeaduater.this, this);
    ...
    private void getGroupFromServer() {
        ...
        AsyncController asyncController = new AsyncController(MainActivityHeaduater.this, this, CallType.GET_HQ_LIST, "", true);
 ...
 /*           if (position > 0) {*/
    ...
    public void getOHETarget() {
        setProgressDialoug(true);
        AsyncController asyncController = new AsyncController(MainActivityHeaduater.this, this, CallType.GET_OHE, "", true);
        asyncController.setProgressDialoug(true);
    ...
    public void addHeadQuater() {
        final Dialog dialog = new Dialog(MainActivityHeaduater.this);
        ...
        btn_sp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkWebView) {
                    ...
                    intent = new Intent(MainActivityHeaduater.this, ProcessSPActivity.class);
                }
                intent.putExtra("selected_group", selected_group);
                intent.putExtra("selected_section", selected_section);
                intent.putExtra("hadquater_id", response.getHeadquater());
...
/*                    intent=new Intent(MainActivityHeaduater.this,HeaduaterTSSWebViewActivity.class);*/
                    if (screen_pos == 1) {
                        ...
                        intent = new Intent(MainActivityHeaduater.this, EntryUserTSSWebViewActivity.class);
                    }
                    intent.putExtra("screen_name", "OHE Report");
                } else {
                    intent = new Intent(MainActivityHeaduater.this, ProcessTSSActivity.class);
                }
                intent.putExtra("selected_group", selected_group);
                intent.putExtra("selected_section", selected_section);
                intent.putExtra("hadquater_id", response.getHeadquater());
        ...
        btn_ssp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkWebView) {
                    ...
                    intent = new Intent(MainActivityHeaduater.this, ProcessSSPActivity.class);
                }
                intent.putExtra("selected_group", selected_group);
                intent.putExtra("selected_section", selected_section);
                intent.putExtra("hadquater_id", response.getHeadquater());
                ...
                try {
                    ...
                    if (jsonObject.has("response_code")) {
                        if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                            ...
                            Util.showLongToast(MainActivityHeaduater.this, "No data available");
