...
public class WebViewActivity extends AppCompatActivity implements AsyncCompleteListner,AdapterView.OnItemSelectedListener {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(openDialog==null) {
               ...
               // openDialog.setTitle("Custom Dialog Box");
                ...
                webviewSpinner.getSettings().setCacheMode(WebSettings.LOAD_DEFAULT);
    ...
    public void onItemSelected(AdapterView<?> arg0, View arg1, int position,long id) {
       ...
       else if(arg0.getId()==R.id.spinnerMonth)
       {
          // Log.e("Key Values",keyValues.get(position));
           if(position<9)
           {
    ...
    public void getOHETarget()
    {
        ...
        AsyncController asyncController=new AsyncController(WebViewActivity.this,this, CallType.GET_OHE,"",true);
    ...
    public void getSPOHETarget()
    {
        ...
        AsyncController asyncController=new AsyncController(WebViewActivity.this,this, CallType.GET_SP_TARGET,"",true);
        asyncController.setProgressDialoug(true);
        asyncController.getOHERequest();
    }
                ...
                try {
                    ...
                    if (jsonObject.has("response_code")) {
                        if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                            Util.showLongToast(WebViewActivity.this, "No data available");
