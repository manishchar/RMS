...
public class PublicViewTSSWebViewActivity extends AppCompatActivity implements AsyncCompleteListner,AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView download_txt = (TextView)findViewById(R.id.download_txt);
        ...
        try {
            ...
            response1=gson.fromJson(LoginDB.getLoginResponseAsJSON(PublicViewTSSWebViewActivity.this),type);
     ...
     //   radioBtnGroup.setVisibility(View.VISIBLE);
       ...
       /* date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                openDatePickerDialog(date1,PublicViewTSSWebViewActivity.this,1);
            }
        });
        ...
        date2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openDatePickerDialog(date2,PublicViewTSSWebViewActivity.this,2);
            }
        });*/
...
/*       if(keyValues.size()>0)
    ...
    public void setProgressDialoug(boolean flag)
    {
        ...
        if(openDialog==null)
        {
            ...
            openDialog= new Dialog(PublicViewTSSWebViewActivity.this);
    ...
    public void getOHETarget()
    {
        ...
        AsyncController asyncController=new AsyncController(PublicViewTSSWebViewActivity.this,this, CallType.GET_TSS_TARGET,"",true);
    ...
    public void getTssType()
    {
        ...
        setProgressDialoug(true);
        AsyncController asyncController=new AsyncController(PublicViewTSSWebViewActivity.this,this, CallType.GET_TSS,"",true);
        asyncController.setProgressDialoug(true);
                ...
                if (callType == CallType.GET_TSS_TARGET) {try {
                        ...
                        if (jsonObject.has("response_code")) {
                            if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                                Util.showLongToast(PublicViewTSSWebViewActivity.this, "No data available");
