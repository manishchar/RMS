package alina.com.rms.activities.public_module.ssp_progress;
...
import alina.com.rms.activities.public_module_adapter.PublicModuleSSPActivityListAdapter;
...
public class PublicModuleProgressSSPList extends PublicModuleBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private PublicModuleSSPActivityListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(PublicModuleProgressSSPList.this);
    ...
    private void hitToServer()
    {
        ...
        AsyncController asyncController=new AsyncController(PublicModuleProgressSSPList.this,this,
    ...
    private void initUI() {
        ...
        servicesListAdapter = new PublicModuleSSPActivityListAdapter(PublicModuleProgressSSPList.this, this,wiringProgressLists);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(PublicModuleProgressSSPList.this, PublicModuleProgressSSPActivity.class);
    ...
    {
        Intent intent = new Intent(PublicModuleProgressSSPList.this,
                PublicModuleProgressSSPEditActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        AlertDialog.Builder builder;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(PublicModuleProgressSSPList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(PublicModuleProgressSSPList.this);
        }
        builder.setTitle("Delete Public Module")
                .setMessage("Are you sure you want to delete this entry?")
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // continue with delete
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(PublicModuleProgressSSPList.this, PublicModuleProgressSSPList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
                ...
                if(response1!=null)
                {
                    if(response1.getActivityProgressList()!=null)
                    {
                       ...
                       // Log.e("value","".size());
                        ...
                        Toast.makeText(PublicModuleProgressSSPList.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(PublicModuleProgressSSPList.this,"no data found",Toast.LENGTH_LONG).show();
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        if(response1.getResponseCode()==1)
                        {
                            ...
                            Toast.makeText(PublicModuleProgressSSPList.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            hitToServer();
                        }

                    }
                    else {
                        Toast.makeText(PublicModuleProgressSSPList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(PublicModuleProgressSSPList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
            ...
            else if(callType==CallType.DELETE_MODULE)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        ...
                        Toast.makeText(PublicModuleProgressSSPList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(PublicModuleProgressSSPList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
