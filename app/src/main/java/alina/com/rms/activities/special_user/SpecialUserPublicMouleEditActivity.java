...
public class SpecialUserPublicMouleEditActivity extends SpecialUserBaseActivity implements AsyncCompleteListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_response = LoginDB.getLoginResponseAsJSON(SpecialUserPublicMouleEditActivity.this);
        Gson gson = new Gson();
...
/*        prj_linear=(LinearLayout)findViewById(R.id.prj_linear);
        ...
        date_linear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openDatePickerDialog(dateTextView, SpecialUserPublicMouleEditActivity.this);
            }
        });
    }

    public void openDatePickerDialog(final TextView editText, SpecialUserPublicMouleEditActivity context) {
        int mYear;
        int mMonth;
        int mDay;
    ...
    public void getCRSList() {
        ...
        AsyncController asyncController = new AsyncController(SpecialUserPublicMouleEditActivity.this, this, CallType.GET_CRS_LIST, "", true);
    ...
    public void saveRkmValue() {
        ...
        setProgressDialoug(true);
        AsyncController asyncController = new AsyncController(SpecialUserPublicMouleEditActivity.this, this, CallType.SET_RKM, "", true);
        asyncController.setProgressDialoug(true);
    ...
    public void updateRkmValue() {
        ...
        setProgressDialoug(true);
        AsyncController asyncController = new AsyncController(SpecialUserPublicMouleEditActivity.this, this, CallType.UPDATE_RKM, "", true);
        asyncController.setProgressDialoug(true);
        ...
        if (response != null) {
            if (callType == CallType.GET_CRS_LIST) {
                try {
                    ...
                    if (jsonObject.has("response_code")) {
                        if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                            Util.showLongToast(SpecialUserPublicMouleEditActivity.this, "No data available");
                ...
                try {
                    ...
                    if (jsonObject.has("response_code")) {
                        if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                            Util.showLongToast(SpecialUserPublicMouleEditActivity.this, jsonObject.getString("message"));
                ...
                if (response1 != null) {
                    if (response1.getResponseCode() != null) {
                        if (response1.getResponseCode() == 1) {
                            //  Log.e("String", "value");
                            Toast.makeText(SpecialUserPublicMouleEditActivity.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            finish();
                        }

                    } else {
                        Toast.makeText(SpecialUserPublicMouleEditActivity.this, "RKM not updated successfully", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(SpecialUserPublicMouleEditActivity.this, "RKM not updated successfully", Toast.LENGTH_LONG).show();
                }
