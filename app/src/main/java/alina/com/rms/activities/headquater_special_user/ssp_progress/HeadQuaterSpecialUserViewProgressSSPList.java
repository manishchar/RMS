package alina.com.rms.activities.headquater_special_user.ssp_progress;
...
import alina.com.rms.activities.headquater_special_user_adapter.HeadQuaterSpecialUserViewSSPActivityListAdapter;
...
public class HeadQuaterSpecialUserViewProgressSSPList extends HeadQuaterSpecialUserBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private HeadQuaterSpecialUserViewSSPActivityListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(HeadQuaterSpecialUserViewProgressSSPList.this);
    ...
    private void hitToServer()
    {
        ...
        AsyncController asyncController=new AsyncController(HeadQuaterSpecialUserViewProgressSSPList.this,this,
                CallType.VIEW_MASTERICTION_MODEL,"",true);
        asyncController.setProgressDialoug(true);
        asyncController.getSSPActivityProgressList(loginResultPojo1.getHeadquater(),""+loginResultPojo1.getRole(),
                loginResultPojo1.getUserId(),loginResultPojo1.getName(),""+loginResultPojo1.getUser_type());

    }

    private void initUI() {
        headingText.setText("SSP Progress List");
        ...
        servicesListAdapter = new HeadQuaterSpecialUserViewSSPActivityListAdapter(HeadQuaterSpecialUserViewProgressSSPList.this, this,wiringProgressLists);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(HeadQuaterSpecialUserViewProgressSSPList.this, HeadQuaterSpecialUserProgressSSPActivity.class);
    ...
    {
        Intent intent = new Intent(HeadQuaterSpecialUserViewProgressSSPList.this,
                HeadQuaterSpecialUserProgressSSPEditActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        AlertDialog.Builder builder;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(HeadQuaterSpecialUserViewProgressSSPList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(HeadQuaterSpecialUserViewProgressSSPList.this);
        }
        builder.setTitle("Delete Public Module")
                .setMessage("Are you sure you want to delete this entry?")
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // continue with delete
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(HeadQuaterSpecialUserViewProgressSSPList.this, HeadQuaterSpecialUserViewProgressSSPList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
                        asyncController.getDeleteSSPProgressActivity(id);
                    }
                })
                .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                ...
                if(response1!=null)
                {
                    if(response1.getActivityProgressList()!=null)
                    {
                       ...
                       // Log.e("value","".size());
                        ...
                        Toast.makeText(HeadQuaterSpecialUserViewProgressSSPList.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(HeadQuaterSpecialUserViewProgressSSPList.this,"no data found",Toast.LENGTH_LONG).show();
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        if(response1.getResponseCode()==1)
                        {
                            ...
                            Toast.makeText(HeadQuaterSpecialUserViewProgressSSPList.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            hitToServer();
                        }

                    }
                    else {
                        Toast.makeText(HeadQuaterSpecialUserViewProgressSSPList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(HeadQuaterSpecialUserViewProgressSSPList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
            ...
            else if(callType==CallType.DELETE_MODULE)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        ...
                        Toast.makeText(HeadQuaterSpecialUserViewProgressSSPList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(HeadQuaterSpecialUserViewProgressSSPList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
