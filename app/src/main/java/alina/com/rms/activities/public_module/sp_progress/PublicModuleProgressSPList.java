package alina.com.rms.activities.public_module.sp_progress;
...
import alina.com.rms.activities.public_module_adapter.PublicModuleSPActivityListAdapter;
...
public class PublicModuleProgressSPList extends PublicModuleBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private PublicModuleSPActivityListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(PublicModuleProgressSPList.this);
    ...
    private void hitToServer()
    {
        ...
        AsyncController asyncController=new AsyncController(PublicModuleProgressSPList.this,this,
    ...
    private void initUI() {
        ...
        servicesListAdapter = new PublicModuleSPActivityListAdapter(PublicModuleProgressSPList.this, this,wiringProgressLists);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(PublicModuleProgressSPList.this, PublicModuleProgressSPActivity.class);
    ...
    {
        Intent intent = new Intent(PublicModuleProgressSPList.this,PublicModuleProgressSPEditActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        AlertDialog.Builder builder;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(PublicModuleProgressSPList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(PublicModuleProgressSPList.this);
        }
        builder.setTitle("Delete Public Module")
                .setMessage("Are you sure you want to delete this entry?")
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // continue with delete
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(PublicModuleProgressSPList.this, PublicModuleProgressSPList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
                ...
                if(response1!=null)
                {
                    if(response1.getActivityProgressList()!=null)
                    {
                       ...
                       // Log.e("value","".size());
                        ...
                        Toast.makeText(PublicModuleProgressSPList.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(PublicModuleProgressSPList.this,"no data found",Toast.LENGTH_LONG).show();
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        if(response1.getResponseCode()==1)
                        {
                            ...
                            Toast.makeText(PublicModuleProgressSPList.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            hitToServer();
                        }

                    }
                    else {
                        Toast.makeText(PublicModuleProgressSPList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(PublicModuleProgressSPList.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
            ...
            else if(callType==CallType.DELETE_MODULE)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        ...
                        Toast.makeText(PublicModuleProgressSPList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(PublicModuleProgressSPList.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
