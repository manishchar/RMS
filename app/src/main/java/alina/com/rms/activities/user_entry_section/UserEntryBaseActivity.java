...
import alina.com.rms.activities.LoginActivity;
...
import alina.com.rms.activities.headquaterActivities.MainActivityHeaduaterTarget;
import alina.com.rms.navDrawer.MakingNavigationDrawerForEntryUser;
import alina.com.rms.navDrawer.RecycleViewClickListener;
import alina.com.rms.navDrawer.RecyclerTouchListener;

public abstract class UserEntryBaseActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public  MakingNavigationDrawerForEntryUser makingNavigationDrawerForEntryUser;
    @Override
    ...
    public void addNavigationView()
    {
     ...
     /*   ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
        ...
        makingNavigationDrawerForEntryUser= new MakingNavigationDrawerForEntryUser(UserEntryBaseActivity.this,recyclerView);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecycleViewClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if(recyclerView.getChildCount()==1)
                {
                    ...
                    new AlertDialog.Builder(UserEntryBaseActivity.this)
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface view,int pos) {
                                    SharedPreferences pref = PreferenceManager
                                            .getDefaultSharedPreferences(UserEntryBaseActivity.this);
                                    SharedPreferences.Editor edit = pref.edit();
                                    edit.clear();
                                    edit.commit();
                                    finish();
                                    Intent intent=new Intent(UserEntryBaseActivity.this,SplashScreen2.class);
                ...
                {
                    Intent intent=new Intent(UserEntryBaseActivity.this, MainActivityEntryUser.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);
                }
                else if(position==1)
                {
                    Intent intent=new Intent(UserEntryBaseActivity.this,MainActivityEntryUser.class);
                    intent.putExtra("daily_reprt_flag",true);
                    startActivity(intent);
                }
               else if(position==2)
                {
                    ...
                    new AlertDialog.Builder(UserEntryBaseActivity.this)
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface view,int pos) {
                                    ...
                                    edit.commit();
                                    finish();
                                    Intent intent=new Intent(UserEntryBaseActivity.this,LoginActivity.class);
                                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                    startActivity(intent);
                                }
                            })
                            .setNegativeButton("Cancel",null)
                            .show();
/*                    Intent intent=new Intent(UserEntryBaseActivity.this, MainActivityHeaduater.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);*/
                }
                ...
                {
                    Intent intent = new Intent(UserEntryBaseActivity.this, HeadquaterSectionListActivity.class);
                    startActivity(intent);
                }
                else if(position==4)
                {

                    Intent intent = new Intent(UserEntryBaseActivity.this, MainActivityHeaduaterTarget.class);
                    startActivity(intent);
    ...
    public void setProgressDialoug(boolean flag)
    {
        ...
        if(openDialog==null)
        {
            ...
            openDialog= new Dialog(UserEntryBaseActivity.this);
    ...
    public void setUnderConstuctionDialoug(boolean flag)
    {
        ...
        if(openDialog1==null)
        {
            ...
            openDialog1= new Dialog(UserEntryBaseActivity.this);
