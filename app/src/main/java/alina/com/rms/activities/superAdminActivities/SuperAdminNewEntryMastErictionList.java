...
import alina.com.rms.adaptor.SuperAdminMastErictionListAdapter;
...
public class SuperAdminNewEntryMastErictionList extends SuperAdminBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private SuperAdminMastErictionListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(SuperAdminNewEntryMastErictionList.this);
    ...
    private void initUI() {
        ...
        servicesListAdapter = new SuperAdminMastErictionListAdapter(SuperAdminNewEntryMastErictionList.this, this,getMastData);
    ...
    private void submitToserver() {
        ...
        AsyncController asyncController=new AsyncController(SuperAdminNewEntryMastErictionList.this,this,
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(SuperAdminNewEntryMastErictionList.this, PublicMouleSuperAdminActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(SuperAdminNewEntryMastErictionList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(SuperAdminNewEntryMastErictionList.this);
        }
        builder.setTitle("Delete Public Module")
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(SuperAdminNewEntryMastErictionList.this,SuperAdminNewEntryMastErictionList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
                ...
                if (callType == CallType.GET_FOUNDATION_LIST) {
                    ...
                    if (response1 != null) {
                        if (response1.getGetMastData() != null) {
                            ...
                            Toast.makeText(SuperAdminNewEntryMastErictionList.this, "no data found", Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(SuperAdminNewEntryMastErictionList.this, "no data found", Toast.LENGTH_LONG).show();
                    }
