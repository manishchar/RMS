...
public class MainActivityHeaduaterTarget extends HeaduaterBaseActivity implements AdapterView.OnItemSelectedListener,AsyncCompleteListner {
    ...
    private CustomAdapter groupNameAdapter,sectionNameAdapter,selectItemAdapter,selectTargetNameAdapter,stationNameAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        response=response1.get(0);
            ...
            headingText.setText("SET Target");
    ...
    private void initView()
    {
        ...
        btn_ohe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getGroupList.size()==0 || sectionlist.size()==0)
                {
                    Util.showLongToast(MainActivityHeaduaterTarget.this,"Either group or section ;ist in not available");
                    return;
                }
                Intent intent = new Intent(MainActivityHeaduaterTarget.this, OHETargetActivity.class);
                intent.putExtra("selected_group",selected_group);
                intent.putExtra("selected_section", selected_section);
                intent.putExtra("selected_station",station_id);
...
/*        mRecyclerView = (RecyclerView) findViewById(R.id.lvHomeScreenItems);
    ...
    private void getGroupFromServer()
    {
        ...
        AsyncController asyncController=new AsyncController(MainActivityHeaduaterTarget.this,this, CallType.GET_HQ_LIST,"",true);
 ...
 /*           if (position > 0) {*/
    ...
    {
        setProgressDialoug(true);
        AsyncController asyncController=new AsyncController(MainActivityHeaduaterTarget.this,this, CallType.GET_OHE,"",true);
        asyncController.setProgressDialoug(true);
    ...
    {
        final Dialog dialog = new Dialog(MainActivityHeaduaterTarget.this);
        ...
        btn_sp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(MainActivityHeaduaterTarget.this,SPTargetActivity.class);
                intent.putExtra("selected_group",selected_group);
                intent.putExtra("selected_section", selected_section);
                intent.putExtra("selected_station",station_id);
                startActivity(intent);
        ...
        btn_tss.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(MainActivityHeaduaterTarget.this,TSSTargetActivity.class);
                intent.putExtra("selected_group",selected_group);
                intent.putExtra("selected_section", selected_section);
                intent.putExtra("selected_station",station_id);
                startActivity(intent);
        ...
        btn_ssp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivityHeaduaterTarget.this,SSPTargetActivity.class);
                intent.putExtra("selected_group",selected_group);
                intent.putExtra("selected_section", selected_section);
                intent.putExtra("selected_station",station_id);
                startActivity(intent);
                ...
                try {
                    ...
                    if (jsonObject.has("response_code")) {
                        if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                            ...
                            Util.showLongToast(MainActivityHeaduaterTarget.this, "No data available");
