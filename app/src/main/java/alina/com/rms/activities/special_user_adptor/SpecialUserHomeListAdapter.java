 ...
 */
public class SpecialUserHomeListAdapter extends RecyclerView.Adapter<SpecialUserHomeListAdapter.ViewHolder> {
    private ServiceClickCallBack callBackListner;
    private Context mContext;
    private String[] homeScreenItems = {"Foundation","MastEriction","Wiring","Progress"};
    private String[] homeScreenItemBackground = {"#8A72B4", "#8A72B4", "#8A72B4", "#8A72B4"};//, "#7EE84A", "#0BCE54", "#4BA4E8", "#2A47E0", "#AF4BE9", "#7D04C1", "#E94BE6", "#C105B2"};
  /*  private String[] homeScreenItemBackground = {"#3B5999","#0077B5", "#21759B", "#3F729B", "#0077B5", "#3B5999","#3AAF85", "#00B489", "#B92b27", "#EB4924",
    ...
    public SpecialUserHomeListAdapter(Context context, ServiceClickCallBack callBackListner) {
