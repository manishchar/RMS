package alina.com.rms.activities.headquater_special_user_adapter;
 ...
 **/
public class HeadQuaterSpecialUserHomeListAdapter extends RecyclerView.Adapter<HeadQuaterSpecialUserHomeListAdapter.ViewHolder> {
    private ServiceClickCallBack callBackListner;
    private Context mContext;
    /*private String[] homeScreenItems = {"Foundation","MastEriction","Wiring","Progress","Progress OHE"};*///,"PSI","TR Line","Other"};
  ...
  /*  private String[] homeScreenItemBackground = {"#3B5999","#0077B5", "#21759B", "#3F729B", "#0077B5",
   "#3B5999","#3AAF85", "#00B489", "#B92b27", "#EB4924",
            "#FF0084", "#F94877"};*/
    ...
    public HeadQuaterSpecialUserHomeListAdapter(Context context, ServiceClickCallBack callBackListner) {
