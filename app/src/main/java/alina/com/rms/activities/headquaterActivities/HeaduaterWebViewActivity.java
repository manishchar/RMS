...
public class HeaduaterWebViewActivity extends AppCompatActivity implements AsyncCompleteListner, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            response1 = gson.fromJson(LoginDB.getLoginResponseAsJSON(HeaduaterWebViewActivity.this), type);
    ...
    private void initUI() {
        ...
        date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                openDatePickerDialog(date1, HeaduaterWebViewActivity.this, 1);
            }
        });
        ...
        date2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openDatePickerDialog(date2, HeaduaterWebViewActivity.this, 2);
            }
        });
        ...
        download_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (keyValues.size() > 0) {
                    ...
                    Toast.makeText(HeaduaterWebViewActivity.this, "Something is wrong", Toast.LENGTH_LONG).show();
                }
            }
...
/*        customMonthAdapter=new CustomAdapter(getApplicationContext(),spinnerMonth);
    ...
    public void setProgressDialoug(boolean flag) {
        ...
        if (openDialog == null) {
            ...
            openDialog = new Dialog(HeaduaterWebViewActivity.this);
    ...
    public void getSPType() {
        ...
        setProgressDialoug(true);
        AsyncController asyncController = new AsyncController(HeaduaterWebViewActivity.this, this, CallType.GET_SECTION_LIST, "", true);
        asyncController.setProgressDialoug(true);
    ...
    public void getOHETarget() {
        ...
        AsyncController asyncController = new AsyncController(HeaduaterWebViewActivity.this, this, CallType.GET_OHE, "", true);
        asyncController.setProgressDialoug(true);
    ...
    public void getSPOHETarget() {
        setProgressDialoug(true);
        AsyncController asyncController = new AsyncController(HeaduaterWebViewActivity.this, this, CallType.GET_SP_TARGET, "", true);
        asyncController.setProgressDialoug(true);
        asyncController.getOHERequest();
    }
                ...
                try {
                    ...
                    if (jsonObject.has("response_code")) {
                        if (Integer.parseInt(jsonObject.getString("response_code")) == 0) {
                            Util.showLongToast(HeaduaterWebViewActivity.this, "No data available");
