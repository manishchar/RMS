...
import alina.com.rms.navDrawer.MakingNavigationDrawerForGroup;
import alina.com.rms.navDrawer.RecycleViewClickListener;
import alina.com.rms.navDrawer.RecyclerTouchListener;

public abstract class GroupBaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void addNavigationView() {
     ...
     /*   ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
        ...
        new MakingNavigationDrawerForGroup(GroupBaseActivity.this, recyclerView);
...
/*                    Intent intent=new Intent(GroupBaseActivity.this,OHEActivity.class);
                    startActivity(intent);*/
                    Intent intent = new Intent(GroupBaseActivity.this, GroupGroupList.class);
                    startActivity(intent);
                } else if (position == 2) {
/*                    Intent intent=new Intent(GroupBaseActivity.this,PSIMainActivity.class);
                    startActivity(intent);*/
                } else if (position == 5) {
                  ...
                  /*  Intent intent=new Intent(GroupBaseActivity.this,GroupMainActivity.class);
                    ...
                    new AlertDialog.Builder(GroupBaseActivity.this)
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface view, int pos) {
                                    SharedPreferences pref = PreferenceManager
                                            .getDefaultSharedPreferences(GroupBaseActivity.this);
                                    SharedPreferences.Editor edit = pref.edit();
                                    edit.clear();
                                    edit.commit();
                                    finish();
                                    Intent intent = new Intent(GroupBaseActivity.this, SplashScreen2.class);
                                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                    startActivity(intent);
                                }
                            })
    ...
    public void setProgressDialoug(boolean flag) {
        ...
        if (openDialog == null) {
            ...
            openDialog = new Dialog(GroupBaseActivity.this);
