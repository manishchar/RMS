...
import alina.com.rms.navDrawer.MakingNavigationDrawerForSuperAdmin;
import alina.com.rms.navDrawer.RecycleViewClickListener;
import alina.com.rms.navDrawer.RecyclerTouchListener;

public abstract class SuperAdminBaseActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void addNavigationView()
    {
     ...
     /*   ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
        ...
        new MakingNavigationDrawerForSuperAdmin(SuperAdminBaseActivity.this,recyclerView);
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecycleViewClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if(position==0)
                {
                    Intent intent=new Intent(SuperAdminBaseActivity.this, MainActivitySuperAdmin.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);
                }
                else if(position==1)
                {
                    Intent intent = new Intent(SuperAdminBaseActivity.this, SuperAdminHQList.class);
                    startActivity(intent);
                }
                else if(position==2)
                {
                    Intent intent = new Intent(SuperAdminBaseActivity.this, SuperAdminGroupList.class);
                    startActivity(intent);
                }
                else if(position==3)
                {

                    Intent intent = new Intent(SuperAdminBaseActivity.this, SuperAdminPublicModuleList.class);
                    startActivity(intent);
                }
                /*else if(position==3)
                {
                ...
                /*else if(position==5)
                {
                    Intent intent = new Intent(SuperAdminBaseActivity.this, SuperAdminViewFoundationList.class);
                    startActivity(intent);
                }
                else if(position==6)
                {
                    Intent intent = new Intent(SuperAdminBaseActivity.this, SuperAdminViewMastErictionList.class);
                    startActivity(intent);
                }
                else if(position==7)
                {
                    Intent intent = new Intent(SuperAdminBaseActivity.this, SuperAdminViewWiringList.class);
                    startActivity(intent);
                }*/
                else if(position==4)
                {

                    new AlertDialog.Builder(SuperAdminBaseActivity.this)
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface view,int pos) {
                                    SharedPreferences pref = PreferenceManager
                                            .getDefaultSharedPreferences(SuperAdminBaseActivity.this);
                                    SharedPreferences.Editor edit = pref.edit();
                                    edit.clear();
                                    edit.commit();
                                    finish();
                                    Intent intent=new Intent(SuperAdminBaseActivity.this,SplashScreen2.class);
                                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                    startActivity(intent);
                                }
                            })
    ...
    public void setProgressDialoug(boolean flag)
    {
        ...
        if(openDialog==null)
        {
            ...
            openDialog= new Dialog(SuperAdminBaseActivity.this);
    ...
    public void setUnderConstuctionDialoug(boolean flag)
    {
        ...
        if(openDialog1==null)
        {
            ...
            openDialog1= new Dialog(SuperAdminBaseActivity.this);
