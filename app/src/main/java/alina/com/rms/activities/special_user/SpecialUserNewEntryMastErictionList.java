...
import alina.com.rms.activities.special_user_adptor.SpecialUserMastErictionListAdapter;
...
public class SpecialUserNewEntryMastErictionList extends SpecialUserBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private SpecialUserMastErictionListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(SpecialUserNewEntryMastErictionList.this);
    ...
    private void initUI() {
        headingText.setText("Add Masteriction List");
        ...
        servicesListAdapter = new SpecialUserMastErictionListAdapter(SpecialUserNewEntryMastErictionList.this, this,getMastData);
    ...
    private void submitToserver() {
        ...
        AsyncController asyncController=new AsyncController(SpecialUserNewEntryMastErictionList.this,this,
                CallType.SAVE_FOUNDATION_ITEM,"",true);
       // asyncController.setProgressDialoug(true);
        asyncController.saveMastListItem(getMastData,date,"");
    ...
    private void hitToServer()
    {
        ...
        asyncController.setProgressDialoug(true);
        asyncController.getMastErictionDataList(section_id);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(SpecialUserNewEntryMastErictionList.this, PublicMouleSuperAdminActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(SpecialUserNewEntryMastErictionList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(SpecialUserNewEntryMastErictionList.this);
        }
        builder.setTitle("Delete Public Module")
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(SpecialUserNewEntryMastErictionList.this, SpecialUserNewEntryMastErictionList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
                ...
                if (callType == CallType.GET_FOUNDATION_LIST) {
                    ...
                    if (response1 != null) {
                        if (response1.getGetMastData() != null) {
                            ...
                            Toast.makeText(SpecialUserNewEntryMastErictionList.this, "no data found", Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(SpecialUserNewEntryMastErictionList.this, "no data found", Toast.LENGTH_LONG).show();
                    }
