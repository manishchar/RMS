...
import alina.com.rms.adaptor.PublicMouleActivityAdapter;
...
public class PublicMouleListActivity extends PublicModuleBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener{


    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private PublicMouleActivityAdapter servicesListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(PublicMouleListActivity.this);
    ...
    private void hitToServer()
    {
        ...
        AsyncController asyncController=new AsyncController(PublicMouleListActivity.this,this,
                CallType.GET_PUBLIC_MODULE_LIST,"",true);
        asyncController.setProgressDialoug(true);
        asyncController.getPublicUserList(String.valueOf(loginResultPojo1.getRole()),loginResultPojo1.getName());
    ...
    private void initUI() {
        ...
        servicesListAdapter = new PublicMouleActivityAdapter(PublicMouleListActivity.this, this,rkmLists);
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(PublicMouleListActivity.this, PublicMouleActivity.class);
    ...
    {
        Intent intent = new Intent(PublicMouleListActivity.this,PublicMouleEditActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(PublicMouleListActivity.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(PublicMouleListActivity.this);
        }
        builder.setTitle("Delete Public Module")
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(PublicMouleListActivity.this,PublicMouleListActivity.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
            ...
            if(callType==CallType.GET_PUBLIC_MODULE_LIST)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getRkmList()!=null)
                    {
                        ...
                        Toast.makeText(PublicMouleListActivity.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(PublicMouleListActivity.this,"no data found",Toast.LENGTH_LONG).show();
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        if(response1.getResponseCode()==1)
                        {
                            ...
                            Toast.makeText(PublicMouleListActivity.this, response1.getMessage(), Toast.LENGTH_LONG).show();
                            hitToServer();
                        }

                    }
                    else {
                        Toast.makeText(PublicMouleListActivity.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(PublicMouleListActivity.this,"Headquater not added successfully",Toast.LENGTH_LONG).show();
            ...
            else if(callType==CallType.DELETE_MODULE)
            {
                ...
                if(response1!=null)
                {
                    if(response1.getResponseCode()!=null)
                    {
                        ...
                        Toast.makeText(PublicMouleListActivity.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(PublicMouleListActivity.this,"Module not deleted successfully",Toast.LENGTH_LONG).show();
