 ...
 */
public class PublicUserHomeListAdapter extends RecyclerView.Adapter<PublicUserHomeListAdapter.ViewHolder> {
  ...
  /*  private String[] homeScreenItemBackground = {"#3B5999","#0077B5", "#21759B", "#3F729B", "#0077B5", "#3B5999","#3AAF85", "#00B489", "#B92b27", "#EB4924",
    ...
    public PublicUserHomeListAdapter(Context context, ServiceClickCallBack callBackListner) {
