...
public abstract class HeadQuaterSpecialUserBaseActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void addNavigationView()
    {
     ...
     /*   ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
        ...
        new MakingNavigationDrawerForSpecialUser(HeadQuaterSpecialUserBaseActivity.this,recyclerView);
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecycleViewClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                //Toast.makeText(getApplicationContext(),  ""+position+" is selected!", Toast.LENGTH_SHORT).show();
                 if(position==0)
                {
                    Intent intent = new Intent(HeadQuaterSpecialUserBaseActivity.this, HeadQuaterSpecialUserViewProgressOHEList.class);
                    startActivity(intent);
                }
                else if(position==1)
                {
                    Intent intent = new Intent(HeadQuaterSpecialUserBaseActivity.this, HeadQuaterSpecialUserViewProgressTSSList.class);
                    startActivity(intent);
                }
                else if(position==2)
                {
                    Intent intent = new Intent(HeadQuaterSpecialUserBaseActivity.this, HeadQuaterSpecialUserViewProgressSPList.class);
                    startActivity(intent);
                }
                 else if(position==3)
                 {
                     Intent intent = new Intent(HeadQuaterSpecialUserBaseActivity.this, HeadQuaterSpecialUserViewProgressSSPList.class);
                     startActivity(intent);
                 }
                 else if(position==4)
                 {
                     Intent intent = new Intent(HeadQuaterSpecialUserBaseActivity.this, ReportActivityHeaduater.class);
                 ...
                 else if(position==5)
                {
                    ...
                    new AlertDialog.Builder(HeadQuaterSpecialUserBaseActivity.this)
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface view,int pos) {
                                    SharedPreferences pref = PreferenceManager
                                            .getDefaultSharedPreferences(HeadQuaterSpecialUserBaseActivity.this);
                                    SharedPreferences.Editor edit = pref.edit();
                                    edit.clear();
                                    edit.commit();
                                    finish();
                                    Intent intent=new Intent(HeadQuaterSpecialUserBaseActivity.this,SplashScreen2.class);
    ...
    public void setProgressDialoug(boolean flag)
    {
        ...
        if(openDialog==null)
        {
            ...
            openDialog= new Dialog(HeadQuaterSpecialUserBaseActivity.this);
    ...
    public void setUnderConstuctionDialoug(boolean flag)
    {
        ...
        if(openDialog1==null)
        {
            ...
            openDialog1= new Dialog(HeadQuaterSpecialUserBaseActivity.this);
