...
import alina.com.rms.adaptor.SuperAdminWiringProgressListAdapter;
...
public class SuperAdminNewEntryProgressList extends SuperAdminBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private SuperAdminWiringProgressListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(SuperAdminNewEntryProgressList.this);
    ...
    private void initUI() {
        ...
        servicesListAdapter = new SuperAdminWiringProgressListAdapter(SuperAdminNewEntryProgressList.this, this,getWiringData);
    ...
    private void submitToserver() {
        ...
        AsyncController asyncController=new AsyncController(SuperAdminNewEntryProgressList.this,this,
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(SuperAdminNewEntryProgressList.this, PublicMouleSuperAdminActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(SuperAdminNewEntryProgressList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(SuperAdminNewEntryProgressList.this);
        }
        builder.setTitle("Delete Public Module")
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(SuperAdminNewEntryProgressList.this,SuperAdminNewEntryProgressList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
                ...
                if (callType == CallType.GET_FOUNDATION_LIST) {
                    ...
                    if (response1 != null) {
                        if (response1.getGetWiringData() != null) {
                            ...
                            Toast.makeText(SuperAdminNewEntryProgressList.this, "no data found", Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(SuperAdminNewEntryProgressList.this, "no data found", Toast.LENGTH_LONG).show();
                    }
