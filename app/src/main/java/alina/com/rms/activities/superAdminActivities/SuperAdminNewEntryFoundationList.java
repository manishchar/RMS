...
import alina.com.rms.adaptor.SuperAdminFoundationListAdapter;
...
public class SuperAdminNewEntryFoundationList extends SuperAdminBaseActivity implements ServiceClickCallBack,AsyncCompleteListner,SwipeRefreshLayout.OnRefreshListener
{

    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private SuperAdminFoundationListAdapter servicesListAdapter;
  ...
  //  RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   String json = gson.toJson(login_response, type);
        ...
        login_response= LoginDB.getLoginResponseAsJSON(SuperAdminNewEntryFoundationList.this);
    ...
    private void initUI() {
        ...
        servicesListAdapter = new SuperAdminFoundationListAdapter(SuperAdminNewEntryFoundationList.this, this,getFoundationData);
    ...
    private void submitToserver() {
        ...
        AsyncController asyncController=new AsyncController(SuperAdminNewEntryFoundationList.this,this,
    ...
    public void addHeadQuater()
    {
        ...
        Intent intent=new Intent(SuperAdminNewEntryFoundationList.this, PublicMouleSuperAdminActivity.class);
    ...
    public void deleteModule(final String id)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(SuperAdminNewEntryFoundationList.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(SuperAdminNewEntryFoundationList.this);
        }
        builder.setTitle("Delete Public Module")
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        setProgressDialoug(true);
                        AsyncController asyncController=new AsyncController(SuperAdminNewEntryFoundationList.this,SuperAdminNewEntryFoundationList.this,CallType.DELETE_MODULE,"",true);
                        asyncController.setProgressDialoug(true);
            ...
            if(callType==CallType.GET_FOUNDATION_LIST)
            {
                ...
                if(response1!=null)
                {
                    ...
                    if(getFoundationData.size()<1)
                    {
                        ...
                        Toast.makeText(SuperAdminNewEntryFoundationList.this,"no data found",Toast.LENGTH_LONG).show();
                    }
                }
                else {
                    Toast.makeText(SuperAdminNewEntryFoundationList.this,"no data found",Toast.LENGTH_LONG).show();
